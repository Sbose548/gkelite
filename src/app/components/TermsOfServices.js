            ...
            <main className="main">
                ...
                <section id="skills" className="skills section container">
                    <div className="our-story" >
                        ...
                        <ul>
                            <li><span>You are at least 18 years old or have the consent of a parent or guardian.</span></li>
                            <li><span>You agree to these terms in full, along with any other policies or guidelines provided by GKeliteinfo.</span></li>
                        </ul>
                        ...
                        <ul>
                            <li><span>3.1 GKeliteinfo provides business solutions and cutting-edge services designed to streamline operations and boost growth.</span></li>
                            <li><span>3.2 You agree to use our services responsibly and in compliance with all applicable laws and regulations.</span></li>
                            <li><span>3.3 Unauthorized use, including but not limited to hacking, data scraping, or attempts to disrupt the website or services, is strictly prohibited.</span></li>
                        ...
                        <ul>
                            <li><span>5.1 You are responsible for maintaining the confidentiality of your account credentials and for all activities under your account.</span></li>
                            <li><span>5.2 You agree to provide accurate, current, and complete information when creating an account or using our services.</span></li>
                        </ul>
                    </div>
